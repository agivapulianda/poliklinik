            ...
            <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
              <thead>
                <tr role="row">
                  ...
                  <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="CSS grade: activate to sort column ascending" style="width: 123.6px;">Jam</th>
              ...
              foreach ($jadwal_poli as $jdw_pl) : ?>
                <tr>
                  <td><?php echo $no++ ?></td>
                  <td><?php echo $jdw_pl->nama_poli ?></td>
                  <td><?php echo $jdw_pl->nama_dok ?></td>
                  <td><?php echo $jdw_pl->nama ?></td>
                  <td><?php echo $jdw_pl->hari ?></td>
                  <td><?php echo $jdw_pl->jam ?></td>
                  <td onclick="javascript:return confirm('Anda yakin hapus ?')"><?php echo anchor('Poliklinik/hapus_jadwal/' . $jdw_pl->id_jadwal, '<div class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></div>') ?></td>
                  <td><?php echo anchor('poliklinik/edit_jadwal/' . $jdw_pl->id_jadwal, '<div class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></div>') ?></td>
                </tr>
              <?php endforeach ?>
            </table>
          </div>
            ...
            <div class="form-grup">
              ...
              <select name="id_poli" id="id_poli" class="form-control">
                ...
                <?php foreach ($M_jadwal_poli as $ls_pl) : ?>
                  <option value="<?= $ls_pl['id_poli']; ?>"><?= $ls_pl['nama_poli']; ?> </option>
                <?php endforeach; ?>
              </select>
            ...
            <div class="form-grup">
              ...
              <select name="id_dokter" id="id_dokter" class="form-control">
                ...
                <?php foreach ($M_getDok as $dr_pl) : ?>
                  <option value="<?= $dr_pl['id_dokter']; ?>"><?= $dr_pl['nama_dok']; ?> </option>
                <?php endforeach; ?>
              </select>
            </div>
            <div class="form-grup">
