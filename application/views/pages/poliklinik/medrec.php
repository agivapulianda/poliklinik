            ...
            <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
              <thead>
                <tr role="row">
                  ...
                  <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="CSS grade: activate to sort column ascending" style="width: 123.6px;">Treatment</th>
              ...
              <?php 
               ...
               foreach ($medrec as $mrc): ?>
                <tr>
                  <td><?php echo $no++ ?></td>
                  <td><?php echo $mrc->nama_pasien?></td>
                  <td><?php echo $mrc->tgl_check?></td>
                  <td><?php echo $mrc->diagnosa?></td>
                  <td><?php echo $mrc->nama_dok?></td>
                  <td><?php echo $mrc->treatment?></td>
                  <td><?php echo $mrc->nama_drugs?></td>
          ...
          <div class="form-grup">
            ...
            <select name="id_pasien" id="id_pasien" class="form-control">
                ...
                <?php foreach ($M_medrec as $mrc) : ?>
                  <option value="<?= $mrc['id_pasien']; ?>"><?= $mrc['nama_pasien']; ?> </option>
                <?php endforeach; ?>
            </select>
          ...
          <div class="form-grup">
            ...
            <select name="id_dokter" id="id_dokter" class="form-control">
                ...
                <?php foreach ($M_getDok as $mrc) : ?>
                  <option value="<?= $mrc['id_dokter']; ?>"><?= $mrc['nama_dok']; ?> </option>
                <?php endforeach; ?>
            </select>
          </div>
          <div class="form-grup">
            ...
            <select name="id_treatment" id="id_treatment" class="form-control">
                ...
                <?php foreach ($M_getDiagnosa as $mrc) : ?>
                  <option value="<?= $mrc['id_treatment']; ?>"><?= $mrc['treatment']; ?> </option>
                <?php endforeach; ?>
            </select>
          </div>
          <div class="form-grup">
            ...
            <select name="id_drugs" id="id_drugs" class="form-control">
                ...
                <?php foreach ($M_getObat as $mrc) : ?>
                  <option value="<?= $mrc['id_drugs']; ?>"><?= $mrc['nama_drugs']; ?> </option>
                <?php endforeach; ?>
            </select>
          </div>
          <div class="form-grup">
