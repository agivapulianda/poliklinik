          ...
          <div class="col-sm-12">
            <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
              <thead>
                ...
                <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="No. Handphone: activate to sort column ascending">Merk</th>
              ...
              <?php 
               ...
               foreach ($obat as $obt): ?>
                <tr>
                  <td><?php echo $no++ ?></td>
                  <td><?php echo $obt->nama_drugs?></td>
                  <td><?php echo $obt->merk?></td>
                  <td><?php echo $obt->type?></td>
                  <td onclick="javascript:return confirm('Anda yakin hapus ?')"><?php echo anchor('Poliklinik/hapus_obat/'.$obt->id_drugs, '<div class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></div>') ?></td>
                  <td><?php echo anchor('poliklinik/edit_obat/'.$obt->id_drugs,'<div class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></div>') ?></td>
                </tr>
              <?php endforeach ?>
            </table>
          </div>
